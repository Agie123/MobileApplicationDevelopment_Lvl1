package com.example.gebruiker.higherlower;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, scores);
...
//                random = new Random().nextInt(6 -1) + 1;
    ...
    public void updateDice(ImageView img, int randomImg){
        int res = getResources().getIdentifier("d"+ randomImg, "drawable", "com.example.gebruiker.higherlower");
